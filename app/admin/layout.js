...
export default async function AdminLayout({
  ...
  /*
   * The actual API authorization remains the security boundary.
   *
   * This layout only controls what navigation the authenticated
   * user should see.
   */
  ...
  return (
    <div className="min-h-screen bg-[#F5F0E8] text-[#171513]">
      ...
      <aside className="fixed inset-y-0 left-0 z-50 hidden w-[250px] border-r border-[#DED6C9] bg-[#FFFDF8] lg:flex lg:flex-col">
        ...
        <div className="border-b border-[#E8E1D6] px-4 py-4">
          <div className="rounded-2xl bg-[#F5F0E8] px-4 py-3">
            ...
            <span className="mt-2 inline-flex rounded-full bg-[#171513] px-2.5 py-1 text-[9px] font-semibold capitalize text-white">
              {displayRole}
            </span>
          </div>
        </div>
            ...
            {visibleSidebarItems.map(
              ({
                ...
                <Link
                  key={href}
                  href={href}
                  className="group flex items-center gap-3 rounded-xl px-3 py-3 text-[#655D54] transition hover:bg-[#F5F0E8] hover:text-[#171513]"
                >
                  <Icon
                    size={17}
                    strokeWidth={1.8}
      ...
      <header className="sticky top-0 z-40 flex h-[68px] items-center justify-between border-b border-[#DED6C9] bg-[#FFFDF8]/95 px-4 backdrop-blur-xl lg:hidden">
        ...
        >
          ...
          <div>
            ...
            <p className="text-[8px] font-semibold uppercase tracking-[0.16em] text-[#B83A2E]">
              {displayRole}
            </p>
          </div>
        </Link>

        <div className="rounded-full bg-[#F5F0E8] px-3 py-1.5 text-[9px] font-bold uppercase tracking-[0.12em] text-[#655D54]">
          {displayRole}
        </div>
      </header>
